            ...
            <div class="twentytwenty-container">
              <ImgComparisonSlider class="compair-slide">
                ...
                >
                  <path
                    stroke="#fff"
                    d="M -5 -1 L -6 0 L -5 1 M 5 -1 L 6 0 L 5 1"
                    stroke-width="2"
                    fill="none"
            ...
            <div class="accordion-item">
              ...
              >
                <div class="accordion-body">
                  <p class="m-b0">
                    Quisque ac quam nibh. Nullam nunc tortor, malesuada sed est eu, ultricies
                    egestas risus. Interdum et malesuada fames ac ante ipsum primis in faucibus.
                    Quisque pulvinar enim urna.
                  </p>
                </div>
              </div>
            </div>
