<template>
  <div class="page-content bg-white">
    <CommonBanner :img="bnr5" title="Ristrutturazioni e Servizi Finanziari" text="Ristrutturazioni e Servizi Finanziari" />
        ...
        <div class="row align-items-center about-bx4">
          <div class="col-lg-6 m-b30 aos-item aos-init aos-animate">
            <div class="section-head style-2">
              ...
              <h2 class="title m-b20">Ristrutturazioni e Servizi Finanziari</h2>
               ...
               <p>•	Assistenza per l’ottenimento di finanziamenti e mutui</p>
